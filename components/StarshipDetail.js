        ...
        <Box>
          ...
          >
            ...
            <Stack textAlign="justify">
              <CardBody>
                <Heading fontWeight="bold" color="orange.400" size='md'>{starship.name}</Heading>
                <Text color="whiteAlpha.800" py='2'>
                  <Text color="orange.200" as="span">Model:</Text> {starship.model}
                </Text>
                <Text color="whiteAlpha.800" py='2'>
                  <Text color="orange.200" as="span">Hyperdrive rating: :</Text> {starship.hyperdrive_rating}
                </Text>
                <Text py='2' color="whiteAlpha.800">
                  <Text color="orange.200" as="span">Max Atmosphering Speed: </Text>{starship.max_atmosphering_speed}
                </Text>
                <Text color="whiteAlpha.800" py='2'>
                ...
                <Text color="orange.200" py='2' as="span"  >Films: </Text>
                <>
