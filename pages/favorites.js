import { Box, Button, Card, IconButton, Image, Center, CardFooter, Stack, Heading, Flex, Text, ButtonGroup } from '@chakra-ui/react'
import { ArrowBackIcon, DeleteIcon, SearchIcon, CloseIcon } from '@chakra-ui/icons'
            ...
            <Flex gap='20' justifyContent='center' flexWrap="wrap" mb="6" mt="5">
                {
                    ...
                    }) : <Text mt="10">You haven't added any movies to your favorites yet !</Text>
                }</Flex>
        </Box>
    )
}
