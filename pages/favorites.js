import { Box, Button, Card, IconButton, Image, Center, CardFooter, Stack, Heading, Flex, Text } from '@chakra-ui/react'
                ...
                <Flex gap='20' justifyContent='center' flexWrap="wrap" mb="6" mt="5">
                    {
                            ...
                            return (
                                <Box bg='#05061d' key={starship.name}>
                                    ...
                                    >
                                        ...
                                        <Stack>
                                            <Heading display="flex" alignItems="center" justifyContent="center" minH="72px" size="md" pt='4' color='orange.400' >
                                                {starship.name}
                                            </Heading>
                                        </Stack>
                                        <Center>
                        ...
                        }) : <Text color="whiteAlpha.800" mt="10">You haven't added any starships to your favorites yet !</Text>
                    }</Flex>
            </Box>
        </>
    )
